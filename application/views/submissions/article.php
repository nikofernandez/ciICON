<div class="container-fluid">
  <h2><span class="fa fa-newspaper-o"></span> Got Any Articles To Share?</h2>
</div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="well">
        ...
        <?php if($this->session->flashdata('article_failed')) : ?>
          <div class="alert alert-dismissible alert-danger">
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <?php echo $this->session->flashdata('article_failed'); ?>
          </div>
        <?php endif; ?>
        ...
        <?php echo form_open_multipart('submissions/article'); ?>
          <div class="form-group">
            <label for="name">Article Name</label><br>
            <input type="text" name="artname" class="form-control" value="" placeholder="Article Name here...">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <p class="help-block">only .doc, .docx, .pdf</p>
          </div>
          <div class="form-group">
